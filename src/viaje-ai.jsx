  ...
  async function generate(){
    ...
    try{
      ...
      const[flRaw,htRaw,rsRaw]=await Promise.all([
        ...
        ai(`5 restaurants in ${planData.destination}. Style: ${tStyle==="backpacker"?"BUDGET street food local markets cheap eats under 8€ per meal price_range must be €":"tStyle==="luxury"?"LUXURY fine dining michelin rooftop upscale expensive price_range must be €€€€":"MID-RANGE casual bistro good food price_range must be €€"}. ${lp} Reply ONLY a JSON array no backticks: [{"name":"...","cuisine":"...","rating":4.2,"price_range":"€","description":"...","neighborhood":"...","lat":0.0,"lng":0.0}]`,"Restaurants",800),
      ]);
