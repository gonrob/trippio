  ...
  async function generate(){
    ...
    try{
      ...
      const[flRaw,htRaw,rsRaw]=await Promise.all([
        ...
        ai(`5 restaurants in ${planData.destination}. Style: ${tStyle==="backpacker"?"BUDGET street food cheap eats under 8 euros":tStyle==="luxury"?"LUXURY fine dining michelin expensive":"MID-RANGE casual bistro good quality"}. ${lp} Reply ONLY a JSON array no backticks: [{"name":"...","cuisine":"...","rating":4.2,"price_range":"€","description":"...","neighborhood":"...","lat":0.0,"lng":0.0}]`,"Restaurants",800),
      ]);
